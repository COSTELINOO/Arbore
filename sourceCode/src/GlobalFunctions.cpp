...
ofstream fout("../../Fisiere_necesare/Utilizatori+parole/utilizatori.txt", std::ios::app);
...
void draw_homepage(fereastra d, int& cod, Font font)
{
	...
	DrawRectangle((d.latime / 2 - marime_text1.x) / 2 - 60, marime_text1.y*2 + 75, marime_text1.x + 125, 5, WHITE);
