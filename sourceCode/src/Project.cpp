...
fstream fin("../../Fisiere_necesare/Utilizatori+parole/utilizatori.txt",std::ios::in | std::ios::out);
...
int main() {
    ...
    //incarcare FONT
    Font font = LoadFontEx("../../Fisiere_necesare/Fonts/seguiemj.ttf", 300, 0, NULL);
    Font font1 = LoadFontEx("../../Fisiere_necesare/Fonts/seguiemj.ttf", 30, 0, NULL);
    Font font2 = LoadFontEx("../../Fisiere_necesare/Fonts/seguiemj.ttf", 24, 0, NULL);
    Font font3 = LoadFontEx("../../Fisiere_necesare/Fonts/seguiemj.ttf", 19, 0, NULL);
